...
define_string_show(audio_mode, audio_mode_buf);
define_string_store(audio_mode, audio_mode_buf, null_cb);
power_attr(audio_mode);
...
static int thermal_max_cores_value;
...
define_int_show(thermal_max_cores, thermal_max_cores_value);
define_int_store(thermal_max_cores, thermal_max_cores_value, null_cb);
power_attr(thermal_max_cores);
