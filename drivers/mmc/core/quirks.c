...
#ifndef SDIO_VENDOR_ID_SPRD
#define SDIO_VENDOR_ID_SPRD		0x0
#endif
#ifndef SDIO_DEVICE_ID_SPRD_x502
#define SDIO_DEVICE_ID_SPRD_x502	0x2260
#endif
#endif
...
#ifdef CONFIG_SPRD_FLASHLESS
	SDIO_FIXUP(SDIO_VENDOR_ID_SPRD, SDIO_DEVICE_ID_SPRD_x502,
		   remove_quirk, MMC_QUIRK_BROKEN_CLK_GATING),
#endif
	END_FIXUP
};
