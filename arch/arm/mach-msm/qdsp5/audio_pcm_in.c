...
static int audio_dsp_set_tx_agc(struct audio_in *audio)
{
	...
	MM_AUD_INFO("comp_rlink_static_gain = 0x%04x\n", cmd.comp_rlink_static_gain);
	MM_AUD_INFO("comp_rlink_aig_flag= 0x%04x\n", cmd.comp_rlink_aig_flag);
	MM_AUD_INFO("expander_rlink_th = 0x%04x\n", cmd.expander_rlink_th);
	MM_AUD_INFO("expander_rlink_slope = 0x%04x\n", cmd.expander_rlink_slope);
	MM_AUD_INFO("compressor_rlink_th = 0x%04x\n", cmd.compressor_rlink_th);
	MM_AUD_INFO("compressor_rlink_slope = 0x%04x\n", cmd.compressor_rlink_slope);
	MM_AUD_INFO("tx_adc_agc_param_mask = 0x%04x\n", cmd.tx_adc_agc_param_mask);
	MM_AUD_INFO("comp_rlink_aig_attackk = 0x%04x\n", cmd.comp_rlink_aig_attackk);
	MM_AUD_INFO("comp_rlink_aig_leak_down = 0x%04x\n", cmd.comp_rlink_aig_leak_down);
	MM_AUD_INFO("comp_rlink_aig_leak_up = 0x%04x\n", cmd.comp_rlink_aig_leak_up);
	MM_AUD_INFO("comp_rlink_aig_max = 0x%04x\n", cmd.comp_rlink_aig_max);
	MM_AUD_INFO("comp_rlink_aig_min = 0x%04x\n", cmd.comp_rlink_aig_min);
	MM_AUD_INFO("comp_rlink_aig_releasek = 0x%04x\n", cmd.comp_rlink_aig_releasek);
	MM_AUD_INFO("comp_rlink_aig_leakrate_fast = 0x%04x\n", cmd.comp_rlink_aig_leakrate_fast);
	MM_AUD_INFO("comp_rlink_aig_leakrate_slow = 0x%04x\n", cmd.comp_rlink_aig_leakrate_slow);
	MM_AUD_INFO("comp_rlink_attackk_msw = 0x%04x\n", cmd.comp_rlink_attackk_msw);
	MM_AUD_INFO("comp_rlink_attackk_lsw = 0x%04x\n", cmd.comp_rlink_attackk_lsw);
	MM_AUD_INFO("comp_rlink_delay = 0x%04x\n", cmd.comp_rlink_delay);
	MM_AUD_INFO("comp_rlink_releasek_msw = 0x%04x\n", cmd.comp_rlink_releasek_msw);
	MM_AUD_INFO("comp_rlink_releasek_lsw = 0x%04x\n", cmd.comp_rlink_releasek_lsw);
	MM_AUD_INFO("comp_rlink_rms_tav = 0x%04x\n", cmd.comp_rlink_rms_tav);
#endif
