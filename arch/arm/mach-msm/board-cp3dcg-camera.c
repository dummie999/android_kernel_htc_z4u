...
static uint32_t cpld_on_gpio_table[] = {
	...
	GPIO_CFG(CP3DCG_GPIO_DATA_0, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_2, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_3, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_4, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_5, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_6, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_7, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_OE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_WE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
#endif
};
...
static uint32_t cpld_off_gpio_table[] = {
	...
	GPIO_CFG(CP3DCG_GPIO_DATA_0, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_2, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_3, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_4, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_5, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_6, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_DATA_7, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_OE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_WE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
#endif
};
...
static void cpld_power(int on)
{
	...
	if (on) {
		...
		gpio_set_value(CP3DCG_GPIO_DATA_0, 0);
		gpio_set_value(CP3DCG_GPIO_DATA_1, 0);
		gpio_set_value(CP3DCG_GPIO_DATA_2, 0);
		gpio_set_value(CP3DCG_GPIO_DATA_3, 0);
		gpio_set_value(CP3DCG_GPIO_DATA_4, 0);
		gpio_set_value(CP3DCG_GPIO_DATA_5, 0);
		gpio_set_value(CP3DCG_GPIO_DATA_6, 0);
		gpio_set_value(CP3DCG_GPIO_DATA_7, 0);
		gpio_set_value(CP3DCG_GPIO_OE, 0);
		gpio_set_value(CP3DCG_GPIO_WE, 0);
	#endif
	}
}
...
int cp3dcg_rawchip_vreg_on(void)
{
	int rc;
...
static int cp3dcg_rawchip_vreg_off(void)
{
	int rc;
...
static struct msm_camera_rawchip_info msm_rawchip_board_info = {
	...
	.rawchip_intr0	= CP3DCG_GPIO_RAW_INTR0,
	.rawchip_intr1	= CP3DCG_GPIO_RAW_INTR1,
	.rawchip_spi_freq = 10, 
...
struct msm_camera_device_platform_data cp3dcg_msm_camera_csi_device_data[] = {
#if 1
	{
...
static void cp3dcg_camera_vreg_config_s5k3h2yx(int vreg_en);
...
static uint32_t camera_off_gpio_table_s5k3h2yx[] = {
	GPIO_CFG(CP3DCG_GPIO_CAM_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_CAM_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
...
static uint32_t camera_on_gpio_table_s5k3h2yx[] = {
	GPIO_CFG(CP3DCG_GPIO_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(CP3DCG_GPIO_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
#ifndef CONFIG_RAWCHIP
	GPIO_CFG(CP3DCG_GPIO_CAM_MCLK,    1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA),
#endif
};
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h2yx_data = {
	...
	.pmic_gpio_enable    = 0,
	.pdata = &cp3dcg_msm_camera_csi_device_data[0],
...
static int config_camera_on_gpios_rear_s5k3h2yx(void)
{
	...
	cp3dcg_camera_vreg_config_s5k3h2yx(1);
...
static int config_camera_off_gpios_rear_s5k3h2yx(void)
{
	...
	cp3dcg_camera_vreg_config_s5k3h2yx(0);
...
#ifdef CONFIG_OV5693
static void cp3dcg_camera_vreg_config_ov5693(int vreg_en);
...
static int config_camera_on_gpios_rear_ov5693(void)
{
	...
	cp3dcg_camera_vreg_config_ov5693(1);
...
static int config_camera_off_gpios_rear_ov5693(void)
{
	...
	cp3dcg_camera_vreg_config_ov5693(0);
...
static void cp3dcg_camera_vreg_config_s5k6a2ya(int vreg_en)
{
	int rc;
	pr_info("[CAM]%s: vreg_en %d\n", __func__, vreg_en);
...
static int config_camera_on_gpios_rear_s5k6a2ya(void)
{
	...
	cp3dcg_camera_vreg_config_s5k6a2ya(1);
...
static int config_camera_off_gpios_rear_s5k6a2ya(void)
{
	...
	cp3dcg_camera_vreg_config_s5k6a2ya(0);
...
static void __init cp3dcg_init_cam(void)
{
	...
	if (htc_get_board_revision() >= BOARD_CPEDCG_EVT_XC) {
		s5k3h2yx_sensor_7627a_info.mirror_flip = CAMERA_SENSOR_NONE;
		pr_info("[CAM]: s5k3h2yx - Use XC layout - mirror_flip = CAMERA_SENSOR_NONE\n");
	} else {
		s5k3h2yx_sensor_7627a_info.mirror_flip = CAMERA_SENSOR_MIRROR_FLIP;
		pr_info("[CAM]: s5k3h2yx - Use XB layout - mirror_flip = CAMERA_SENSOR_MIRROR_FLIP\n");
	}
#endif
