...
static uint32_t cpld_on_gpio_table[] = {
	...
	GPIO_CFG(Z4U_GPIO_DATA_0, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_2, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_3, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_4, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_5, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_6, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_7, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_OE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_WE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
#endif
};
...
static uint32_t cpld_off_gpio_table[] = {
	...
	GPIO_CFG(Z4U_GPIO_DATA_0, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_2, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_3, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_4, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_5, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_6, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_DATA_7, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_OE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
...
static void cpld_power(int on)
{
	...
	if (on) {
		...
		gpio_set_value(Z4U_GPIO_DATA_0, 0);
		gpio_set_value(Z4U_GPIO_DATA_1, 0);
		gpio_set_value(Z4U_GPIO_DATA_2, 0);
		gpio_set_value(Z4U_GPIO_DATA_3, 0);
		gpio_set_value(Z4U_GPIO_DATA_4, 0);
		gpio_set_value(Z4U_GPIO_DATA_5, 0);
		gpio_set_value(Z4U_GPIO_DATA_6, 0);
		gpio_set_value(Z4U_GPIO_DATA_7, 0);
		gpio_set_value(Z4U_GPIO_OE, 0);
		gpio_set_value(Z4U_GPIO_WE, 0);
	#endif
	}
}
...
static void z4u_camera_vreg_config_imx175(int vreg_en);
#endif

int z4u_rawchip_vreg_on(void)
{
	int rc;
...
static int z4u_rawchip_vreg_off(void)
{
	int rc;
...
struct msm_camera_device_platform_data z4u_msm_camera_csi_device_data[] = {
#if 1
	{
...
static void z4u_camera_vreg_config_s5k3h2yx(int vreg_en);
...
static uint32_t camera_off_gpio_table_s5k3h2yx[] = {
	GPIO_CFG(Z4U_GPIO_CAM_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_CAM_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
...
static uint32_t camera_on_gpio_table_s5k3h2yx[] = {
	GPIO_CFG(Z4U_GPIO_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
#ifndef CONFIG_RAWCHIP
	GPIO_CFG(Z4U_GPIO_CAM_MCLK,    1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA),
#endif
};
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h2yx_data = {
	...
	.pmic_gpio_enable    = 0,
	.pdata = &z4u_msm_camera_csi_device_data[0],
...
static int config_camera_on_gpios_rear_s5k3h2yx(void)
{
	...
	z4u_camera_vreg_config_s5k3h2yx(1);
...
static int config_camera_off_gpios_rear_s5k3h2yx(void)
{
	...
	z4u_camera_vreg_config_s5k3h2yx(0);
...
#if defined(CONFIG_IMX175)
static int config_camera_on_gpios_rear_imx175(void);
static int config_camera_off_gpios_rear_imx175(void);

static uint32_t camera_off_gpio_table_imx175[] = {
	GPIO_CFG(Z4U_GPIO_CAM_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_CAM_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
#ifndef CONFIG_RAWCHIP
	GPIO_CFG(Z4U_GPIO_CAM_MCLK,    0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
...
static uint32_t camera_on_gpio_table_imx175[] = {
	GPIO_CFG(Z4U_GPIO_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(Z4U_GPIO_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
#ifndef CONFIG_RAWCHIP
	GPIO_CFG(Z4U_GPIO_CAM_MCLK,    1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA),
...
static struct msm_camera_gpio_conf gpio_conf_imx175 = {
#if 0
	.camera_off_table = camera_off_gpio_table,
	.camera_off_table_size = ARRAY_SIZE(camera_off_gpio_table),
	.camera_on_table = camera_on_gpio_table,
	.camera_on_table_size = ARRAY_SIZE(camera_on_gpio_table),
	.cam_gpio_req_tbl = imx175_cam_req_gpio,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(imx175_cam_req_gpio),
	.cam_gpio_set_tbl = imx175_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(imx175_cam_gpio_set_tbl),
#endif
	.gpio_no_mux = 1,
};
...
static struct msm_camera_sensor_flash_src msm_flash_src_imx175 = {
	.flash_sr_type = MSM_CAMERA_FLASH_SRC_CURRENT_DRIVER,
	.camera_flash = flashlight_control,
};
...
static struct msm_camera_sensor_flash_data flash_imx175 = {
	.flash_type             = MSM_CAMERA_FLASH_LED,
#ifdef CONFIG_MSM_CAMERA_FLASH
	.flash_src              = &msm_flash_src_imx175,
#endif
};

static struct msm_camera_sensor_platform_info imx175_sensor_7627a_info = {
	.mount_angle = 90,
#if 0
	.cam_vreg = msm_cam_vreg,
	.num_vreg = ARRAY_SIZE(msm_cam_vreg),
#endif
	.gpio_conf = &gpio_conf_imx175,
	.mirror_flip = CAMERA_SENSOR_NONE,
};

static struct msm_camera_sensor_info msm_camera_sensor_imx175 = {
	.sensor_name = "imx175",
	.camera_power_on = config_camera_on_gpios_rear_imx175,
	.camera_power_off = config_camera_off_gpios_rear_imx175,
	.sensor_reset_enable = 0,
	.sensor_reset = 0,
	.sensor_pwd = CPLD_EXT_GPIO_CAM_PWDN,
	.pmic_gpio_enable    = 0,
	...
	.sensor_platform_info = &imx175_sensor_7627a_info,
	.csi_if = 1,
...
static int config_camera_on_gpios_rear_imx175(void)
{
	...
	pr_info("[CAM]%s: config gpio on table\n", __func__);
	rc = config_gpio_table(camera_on_gpio_table_imx175,
			ARRAY_SIZE(camera_on_gpio_table_imx175));
	if (rc < 0) {
		pr_err("[CAM]%s: CAMSENSOR gpio table request failed\n", __func__);
		return rc;
	}
...
static int config_camera_off_gpios_rear_imx175(void)
{
	...
	rc = config_gpio_table(camera_off_gpio_table_imx175,
			ARRAY_SIZE(camera_off_gpio_table_imx175));
	if (rc < 0) {
		pr_err("[CAM]%s: CAMSENSOR gpio table request failed\n", __func__);
		return rc;
	}
...
static void z4u_camera_vreg_config_s5k6a2ya(int vreg_en)
{
	int rc;
	pr_info("[CAM]%s: vreg_en %d\n", __func__, vreg_en);
...
static int config_camera_on_gpios_rear_s5k6a2ya(void)
{
	...
	z4u_camera_vreg_config_s5k6a2ya(1);
...
static int config_camera_off_gpios_rear_s5k6a2ya(void)
{
	...
	z4u_camera_vreg_config_s5k6a2ya(0);
...
static void __init z4u_init_cam(void)
{
...
static struct i2c_board_info i2c_camera_devices_2nd_source[] = {
#ifdef CONFIG_IMX175
	{
		...
		.platform_data = &msm_camera_sensor_imx175,
	},
#endif
#ifdef CONFIG_S5K6A2YA
	{
...
void __init z4u_camera_init(void)
{
	...
	rc = gpio_request(Z4U_GPIO_CAM_ID, "MSM_CAM_ID");
	...
	if (rc < 0) {
		...
		gpio_tlmm_config(
			GPIO_CFG(Z4U_GPIO_CAM_ID, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
			GPIO_CFG_ENABLE);
		gpio_free(Z4U_GPIO_CAM_ID);
	}
	...
	else
	{
		if (voltage == 0) { 
			...
			cMainSensor = MAIN_SENSOR_IMX175;
		}
	}
#endif
}
